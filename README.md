Getting started with MemSQL and C#
==================================


Whether you're using an ORM like Entity Framework or straight SQL, you can get started with MemSQL fast. Here's an introductory sample of using MemSQL with C#. This sample includes all the CRUD methods: Create, Read by id, Read all, Update, and Delete.
